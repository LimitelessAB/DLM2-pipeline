...
def master_function(DustPy_parameters,number_of_vertical_cells,Settling_type,MCFOST_parameters,DustPy_slices_list_to_run,MCFOST_image_parameters,PSF_parameters=None,convolution_triggered_list=None,parametric_parameters=None):
    prLightPurple("="*68)
    ...
    #DustPy run
    run_DustPy_function(DustPy_parameters)
