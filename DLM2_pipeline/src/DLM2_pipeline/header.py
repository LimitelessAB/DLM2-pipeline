...
class DustPy_parameters:
    ...
    def __init__(self):
            ...
            self.a_monomer = 1e-4 #Monomer size in microns
    ...
    def set_variables(self,parameter_array):
        ...
        if parameter_array[25]!=None: self.a_monomer = parameter_array[25] #Monomer size in microns
    ...
    def choose_variables(self):  
        ...
        for i in range(0,30):
            ...
            textboxes[i].insert(0, str(default_parameter_array[i]))
...
class MCFOST_parameters:
    ...
    def update_parameters(self,parameter_array,n_rin):
        ...
        # -- Density structure --
        for k in range(self.parameters.simu.n_zones):
        ...
        # -- Star properties --
        for k in range(self.parameters.simu.n_stars):
